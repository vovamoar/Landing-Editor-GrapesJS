            ...
            <div class="modal-body">
                <div class="d-flex justify-content-center">
                    <div class="btn-group" role="group" aria-label="Language Selector">
                        ...
                        <button type="button" onclick="setLanguageCookie('<?= $availableLocale ?>')"
                            class="btn btn-outline-primary mx-2" data-locale="<?= $availableLocale ?>">
...
</svg> <?= $translate('common.language-selector.' . $availableLocale) ?>
                        </button>
                        <?php endforeach; ?>
                    </div>
                </div>
